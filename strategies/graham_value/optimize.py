...
Usage:
    python strategies/graham_value/optimize.py                    # 200 trials, single-period
    python strategies/graham_value/optimize.py --walk-forward     # 200 trials, walk-forward validation
    python strategies/graham_value/optimize.py --n-trials 5       # Quick smoke test
"""
...
def graham_search_space(trial: optuna.Trial) -> dict:
...
def main():
    ...
    parser.add_argument("--study-name", default="graham_v1", help="Optuna study name")
    args = parser.parse_args()

    print("=" * 80)
    print("  BAYESIAN PARAMETER OPTIMIZATION — Graham Value Strategy")
    ...
    study = run_optimization(
        ...
        suggest_params=graham_search_space,
    ...
    print(f"  python strategies/graham_value/portfolio_run.py  (uses '{output}')")
    print("=" * 80)
